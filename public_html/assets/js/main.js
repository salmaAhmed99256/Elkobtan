(function ($) {
  ...
  var autoshowTheme = {
    ...
    // Sticky Header
    sticky: function () {
      var transparentLogo = $("#header .main-logo img").attr(
      ...
      $(window).on("scroll load", function () {
        ...
        if ($(window).scrollTop() >= headerOffset) {
          ...
          $(".wrapper-with-transparent-header #header")
            .addClass("sticky")
    ...
    // Attach event handlers for features
    // Attach event handlers for features
    attachFeaturesEventHandlers: function () {
      $(".features .has-childrenFeatures > a").on("click", function (event) {
        event.preventDefault();
        var selected = $(this).parent();
        selected.find("ul").toggleClass("is-hidden"); // Toggle is-hidden class
        selected.siblings().find("ul").addClass("is-hidden");
        $(".overlay").addClass("is-visible");
      });

      // Handle click event on "Go back" link
      $(".features .go-back").on("click", function () {
        $(this).parent("ul").addClass("is-hidden");
      });

      // Handle click event on close button
      $(".features .nav-drop-close").on("click", function () {
        $(this)
          .parent("ul")
          .parent(".has-childrenFeatures")
          .children("a")
    ...
    menuNav: function () {
      ...
      $(window).on("resize", function () {
        !window.requestAnimationFrame
          ? setTimeout(autoshowTheme.moveNavigation, 300)
          : window.requestAnimationFrame(autoshowTheme.moveNavigation);
      });
      ...
      $(".nav-drop-close").on("click", function () {
        //$(this).parent('ul').addClass('is-hidden').parent('.has-childrenFeatures').parent('ul').removeClass('moves-out');
        $(this)
          .parent("ul")
          .parent(".has-childrenFeatures")
          .children("a")
        ...
        $(".interest-point")
          ...
          .on("click", function () {
            ...
            if (selectedPoint.hasClass("is-open")) {
              ...
              selectedPoint
                .addClass("is-open")
                .siblings(".interest-point.is-open")
                .removeClass("is-open");
            }
          });
